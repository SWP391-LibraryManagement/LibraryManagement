...
- [ ] **Step 1: Add the candidate contract to SPEC.md.**
...
- [ ] **Step 2: Update PLAN.md, TASKS.md, and CHANGELOG.md.**
...
- [ ] **Step 3: Verify documentation traceability.**
...
- [ ] **Step 4: Commit the source-of-truth update.**
...
- [ ] **Step 1: Extend the in-memory candidate state.**
...
- [ ] **Step 2: Add RED route tests tagged with the new IDs.**
...
- [ ] **Step 2: Mount the route and controller.**
...
- [ ] **Step 4: Add the parameterized SQL repository method.**
...
- [ ] **Step 1: Add guarded setup and cleanup.**

Follow the existing `backend/tests/sql/*.sqltest.js` pattern: load `SYSTEM_SQL_TEST_ENV_FILE` before DB imports, require `SYSTEM_SQL_TEST_ALLOW_MUTATION=true`, generate unique in-memory seed suffixes, track every inserted ID, and delete all synthetic rows in a `finally`-equivalent cleanup path.

- [ ] **Step 2: Seed all relevant statuses.**
...
- [ ] **Step 3: Assert filtering, counts, ordering, pagination, and redaction.**
...
- [ ] **Step 1: Add API method and RED source tests.**
...
- [ ] **Step 3: Replace the local catalog state.**
...
- [ ] **Step 4: Render safe fields and preserve mutation semantics.**
...
- [ ] **Step 5: Remove the static export.**
...
- [ ] **Step 3: Assert server search and real mutation.**
...
- [ ] **Step 3: Update focused evidence.**
...
- [ ] **Step 4: Close TD-028 only after all evidence passes.**
...
- [ ] **Step 5: Update the acceptance packet.**
