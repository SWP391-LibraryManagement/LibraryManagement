...
| TD-014 | FE11 User & Role | P1 | Role mutation now returns deterministic 404s for missing actor/target/role and revalidates the active acting Admin inside the transaction. Remaining user detail/update/deactivation and other non-role action semantics still require reconciliation. | VG FE11 P1-6/7 | PARTIAL |
| TD-015 | FE11 User & Role | P1 | Service-level coverage now exists for account setup/resend and transactional role outcomes. Remaining user list/detail/update/deactivation/audit business rules still need focused service tests. | VG FE11 P0-2 | PARTIAL |
