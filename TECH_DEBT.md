...
| TD-022 | FE11 User & Role | P1 | Admin role-action UI sends `roleName` in the request body/path, while the approved API and backend validators require positive numeric `roleId`; assignment/revocation from the UI cannot satisfy AC-FE11-013/014. | FE11 context drift audit | OPEN |
