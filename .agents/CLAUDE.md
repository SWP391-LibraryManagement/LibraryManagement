...
- **Current SDD scope**: all 12 Phase 1 feature `SPEC.md` files are **APPROVED**. `PLAN.md` + `TASKS.md` are **READY FOR REVIEW** (implemented vertical slice) for 4 features:
  - FE02 `feat-auth`, FE07 `feat-borrowing-management`, FE08 `feat-reservation-management`, and FE09 `feat-fine-management`.
