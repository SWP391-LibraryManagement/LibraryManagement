...
module.exports = defineModel({
  ...
  columns: [
    ...
    { attribute: 'dueDate', name: 'DueDate', type: 'DATE', nullable: true },
    ...
    { attribute: 'status', name: 'Status', type: 'NVARCHAR(20)', required: true, default: 'REQUESTED', allowedValues: ['REQUESTED', 'BORROWED', 'RETURNED', 'LOST', 'DAMAGED'] },
