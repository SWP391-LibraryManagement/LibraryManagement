...
| ------- | ---- | ----- | --------- | ------------------ |
| 1.0 | 02-06-2026 | A | DungTH | FE05 Book Management specification created. |
| 1.0 | 03-06-2026 | A | DatDT | FE02 Authentication feature specification structure created. |
| 1.0 | 03-06-2026 | A | DungTH | FE11 User & Role Management feature specification structure created. |
| 1.0 | 10-06-2026 | A | DungTH | FE01 Public Browse review decisions approved. |
| 1.0 | 10-06-2026 | A | DatDT | FE02 foundation slice implemented and authentication flows ready for review. |
| 1.0 | 10-06-2026 | A | DatDT | FE03 User Profile review decisions approved. |
| 1.0 | 10-06-2026 | A | DatDT | FE04 Membership Management review decisions approved. |
| 1.0 | 10-06-2026 | A | DatDT | FE06 Inventory/Book Copy review decisions approved. |
| 1.0 | 10-06-2026 | A | NhatNHA | FE07 Borrowing backend slice ready for review. |
| 1.0 | 10-06-2026 | A | NhatNHA | FE08 Reservation backend slice ready for review. |
| 1.0 | 10-06-2026 | A | DungTH | FE09 Fine Management review decisions approved. |
| 1.0 | 10-06-2026 | A | NhatNHA | FE10 Notification backend slice ready for review. |
| 1.0 | 10-06-2026 | A | NhatNHA | FE12 Reporting backend slice ready for review. |
| 1.0 | 20-06-2026 | A | DatDT | FE03 backend and frontend avatar upload implemented. |
| 1.0 | 20-06-2026 | A | NhatNHA | FE07 frontend UI implemented and accessibility validated. |
| 1.0 | 20-06-2026 | A | NhatNHA | FE08 frontend UI implemented and accessibility validated. |
| 1.0 | 20-06-2026 | A | NhatNHA | FE12 frontend UI implemented and accessibility validated. |
| 1.0 | 25-06-2026 | A | DungTH | FE09 server-side implementation completed. |
| 1.0 | 10-07-2026 | M | NhatNHA | FE12 inventory category filter completed. |
| 1.0 | 13-07-2026 | M | NhatNHA | FE08 frontend correctness aligned with approved lifecycle. |
| 1.0 | 13-07-2026 | M | NhatNHA | FE10 hardening implemented and B7 integration closed out. |
| 1.0 | 13-07-2026 | M | NhatNHA | FE12 B7 integration and review closeout completed. |
| 1.0 | 14-07-2026 | M | NhatNHA | FE07 B7 integration and validation closeout completed. |
| 1.0 | 15-07-2026 | M | DungTH | FE01 read-only availability ownership defined. |
| 1.0 | 15-07-2026 | M | DatDT | FE02 account setup implementation and validation completed. |
| 1.0 | 15-07-2026 | M | DatDT | FE04 canonical membership contract added. |
| 1.0 | 15-07-2026 | M | DungTH | FE05 catalog ownership and deterministic contract added. |
| 1.0 | 15-07-2026 | M | DatDT | FE06 deterministic inventory contract added. |
| 1.0 | 15-07-2026 | M | NhatNHA | FE10 account setup delivery implemented and OTP security boundary approved. |
| 1.0 | 15-07-2026 | M | DungTH | FE11 account setup slice implemented and validation ready. |
| 1.0 | 17-07-2026 | M | DatDT | FE03 deterministic profile and avatar failure contracts updated. |
| 1.0 | 18-07-2026 | M | DungTH | FE01 authenticated homepage navigation updated. |
| 1.0 | 18-07-2026 | M | DatDT | FE04 member, librarian, and admin review UI integrated. |
| 1.0 | 18-07-2026 | M | DungTH | FE05 librarian book management navigation and catalog metadata timestamps updated. |
| 1.0 | 18-07-2026 | M | DatDT | FE06 navigation label clarified. |
| 1.0 | 18-07-2026 | M | NhatNHA | FE07 member and librarian borrowing workspace polished. |
| 1.0 | 18-07-2026 | M | NhatNHA | FE08 member and librarian reservation operations aligned with canonical data. |
| 1.0 | 18-07-2026 | M | DungTH | FE09 librarian fine navigation and page restored. |
| 1.0 | 18-07-2026 | M | DungTH | FE11 transactional role management, safe user reads, admin role UI, and audit log integrated. |
| 1.0 | 19-07-2026 | M | DatDT | FE02 FE11 finalization schema contract activated. |
| 1.0 | 19-07-2026 | M | DatDT | FE03 FE11 librarian column ownership activated. |
| 1.0 | 19-07-2026 | M | NhatNHA | FE10 recipient email width synchronization activated. |
| 1.0 | 19-07-2026 | M | DungTH | FE11 admin navigation permissions and finalization governance activated. |
| 1.0 | 19-07-2026 | M | DatDT | System access login and setting management screen details completed. |
...
<img src="./diagrams/use-case/01-overall-use-cases.svg" alt="Overall Library Management System use case diagram">

PlantUML source: [`01-overall-use-cases.puml`](./diagrams/use-case/01-overall-use-cases.puml).

##### Figure 2. Authentication, Public Browsing, Profile, And Membership Use Cases

<img src="./diagrams/use-case/02-access-membership.svg" alt="Authentication, public browsing, profile, and membership use case diagram">

PlantUML source: [`02-access-membership.puml`](./diagrams/use-case/02-access-membership.puml).

##### Figure 3. Borrowing, Reservation, And Fine Use Cases

<img src="./diagrams/use-case/03-circulation-fines.svg" alt="Borrowing, reservation, and fine use case diagram">

PlantUML source: [`03-circulation-fines.puml`](./diagrams/use-case/03-circulation-fines.puml).

##### Figure 4. Catalog, Inventory, Administration, Notification, And Reporting Use Cases

<img src="./diagrams/use-case/04-administration-reporting.svg" alt="Catalog, inventory, administration, notification, and reporting use case diagram">

PlantUML source: [`04-administration-reporting.puml`](./diagrams/use-case/04-administration-reporting.puml).
