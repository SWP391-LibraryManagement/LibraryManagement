...
Workflow State: SPEC v0.2.1 and FE04-T006 source-boundary revision are approved; implementation not started
...
- [ ] **FE04-T001 - Add RED membership contract and concurrency tests.**
...
- [ ] **FE04-T002 - Reconcile SQL and persistence contracts.**
...
- [ ] **FE04-T003 - Reconcile authentication, authorization, validation, and API contract.**
  ...
  - Files: `backend/src/routes/membershipRoutes.js`, `backend/src/controllers/membershipController.js`, `backend/src/validators/membershipValidators.js`, `backend/src/docs/openapi.yaml`.
  - Dependency: FE04-T001.
...
- [ ] **FE04-T004 - Implement canonical apply, re-application, and own-status behavior.**
...
- [ ] **FE04-T005 - Implement atomic approval and rejection.**
...
- [ ] **FE04-T006 - Add post-commit FE10 membership-result delivery.**
...
- [ ] **FE04-T007 - Reconcile staff list and applicant-safe response fields.**
...
- [ ] **FE04-T008 - Reconcile the membership frontend with server truth.**
