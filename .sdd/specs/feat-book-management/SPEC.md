...
| FR-FE05-032 | UC21, UC23, UC24 | `bookManagementFrontend.test.js` canonical status-column contract | Automated pass; human review pending |
...
| AC-FE05-023 | UC21, UC23, UC24 | `bookManagementFrontend.test.js`; `bookRoutes.test.js` unaffected-row assertions | Automated pass; human review pending |

Coverage: 22/22 BR, 32/32 FR, and 23/23 AC have current automated evidence mappings.
