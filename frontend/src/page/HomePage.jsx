            ...
            <div style={{ background: '#FFF', borderRadius: 14, border: '1px solid rgba(78,52,46,0.1)', overflow: 'hidden' }}>
              ...
              <div style={{ padding: '20px 24px' }}>
                ...
                {[
                  ...
                  { label: 'Phí trễ hạn', value: '5.000 ₫ / ngày' },
    ...
    <div style={{ fontFamily: 'Lato, sans-serif', background: '#FAF7F2', minHeight: '100vh', overflowX: 'hidden' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 28 }}>
            <div>
              <p style={{ fontSize: 11, color: '#C78A3B', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', margin: '0 0 6px' }}>
                {isLoggedIn ? 'Tìm kiếm thành viên' : 'Tìm kiếm khách'} — Ca sử dụng {isLoggedIn ? '19' : '18'}
              </p>
      ...
      <section id="section-cta" style={{ background: '#EDE0CE', padding: '72px 80px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            {[
              { icon: '📖', title: 'Mượn sách linh hoạt', desc: 'Mượn tối đa 5 cuốn cùng lúc theo quy định thư viện.' },
              { icon: '🔔', title: 'Thông báo sách mới', desc: 'Nhận thông báo sớm khi có đầu sách mới.' },
              { icon: '📋', title: 'Danh sách đọc', desc: 'Tạo và quản lý bộ sưu tập sách cá nhân.' },
              { icon: '🎟️', title: 'Sự kiện riêng', desc: 'Tham gia các buổi giao lưu tác giả và câu lạc bộ đọc sách dành cho thành viên.' },
            ].map(item => (
